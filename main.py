...
def registration_form():
    ...
    # HeadTitle
    head_label = Label(window, text="Attendance System", bg="#c4c4c4", height=1, width=25,
    ...
    capture_printButton = Button(window, text="Capture Student Image", font=("Castelli", 12, 'bold'), fg="grey")
    capture_printButton.pack()
    capture_printButton.place(relx=0.52, rely=0.55, anchor='center')

    save_printButton = Button(window, text="Save Details", font=("Castelli", 12, 'bold'), fg="grey")
...
# Buttons
atten_lable = Button(window, text="Take Attendance", command = main, font=("Castelli", 12, 'bold'), fg="grey")
atten_lable.pack()
atten_lable.place(relx=0.42, rely=0.55, anchor='se')

regis_lable = Button(window, text="Registration", command = registration_form, font=("Castelli", 12, 'bold'), fg="grey")
regis_lable.pack()
regis_lable.place(relx=0.72, rely=0.55, anchor='se')
